...
| `probe_banner.py` | Banner art data well-formed, blank-border crop, half-block render height, wordmark gradient, +2/centred composition; `theme_palette`/`nearest_color` recolour helpers (imports `scripts/pixart_image_integrator.py`) |
